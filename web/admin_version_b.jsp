            ...
            <section class = "content_container2" id = "graph_container">    
                <ul class="tab">
                    ...
                    <script>
                        ...
                        {
                            var tableInputSpace = document.getElementById("table_input_space");
							...
							p.setAttribute("value","param name");
                            p.setAttribute("width", "20px");  
							tableInputSpace.innerHtml+="Date ";
                            tableInputSpace.appendChild(d);
                            tableInputSpace.appendChild(t);
                            tableInputSpace.appendChild(p);
